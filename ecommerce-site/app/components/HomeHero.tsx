    ...
    <div className="relative mx-auto flex min-h-[80vh] max-w-6xl flex-col items-center px-4 pb-20 pt-10 md:flex-row md:items-center md:justify-between md:pt-16">
      ...
      <div className="z-10 mb-10 max-w-xs md:mb-0 md:w-1/4">
        ...
        <div className="mt-6 flex flex-wrap gap-3">
          <Link
// Using the direct profile link usually works, but ensure it's formatted exactly like this:
href="instagram://user?username=missyandmoppet" 
// Fallback for desktop: Most modern browsers handle the redirect, 
// but a more robust way is to use a simple script or a smart URL.
onClick={(e) => {
  // Optional: Logic to check if mobile and redirect accordingly
  // For many, simply using the standard https link works if the user has the app,
  // but the following is the most compatible standard:
  window.location.href = "https://www.instagram.com/missyandmoppet/";
}}
target="_blank"
