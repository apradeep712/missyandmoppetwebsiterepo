...
/**
 * IMPORTANT: 
 * 1. Place your files in: /public/insta/
 * 2. Ensure the extensions (.mp4, .jpg, etc.) match your actual files exactly.
 * 3. Do not use the full /workspaces/... path. Use the short /insta/... path.
 */
const items = [
  { id: 1, label: 'Social photo / reel 1', src: '/insta/insta1.mp4', type: 'video' },
  { id: 2, label: 'Social photo / reel 2', src: '/insta/insta2 (1).mp4', type: 'video' },
  { id: 3, label: 'Social photo / reel 3', src: '/insta/insta3.mp4', type: 'video' },
  { id: 4, label: 'Social photo / reel 4', src: '/insta/insta4.mp4', type: 'video' },
  { id: 5, label: 'Social photo / reel 5', src: '/insta/insta6.jpg', type: 'image' },
];
            ...
            {items.map((item, idx) => (
              ...
              >
                ...
                <div className="absolute inset-x-0 bottom-0 p-3">
                  <div className="rounded-2xl bg-white/85 px-3 py-2 text-[11px] text-slate-900 shadow backdrop-blur-sm">
                    {item.label}
                  </div>
                </div>
                ...
                <div className="absolute left-2 top-2 flex items-center gap-2">
                  ...
                  <div className="rounded-full bg-black/40 px-2 py-0.5 text-[10px] font-medium text-white backdrop-blur-md">
                    {item.type === 'video' ? 'Reel' : 'Story'}
                  </div>
                </div>
              </motion.div>
            ))}
