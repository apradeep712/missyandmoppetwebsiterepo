...
import PinGate from './PinGate'; // Ensure this path matches where your PinGate is
    ...
    <>
      <Link href="/admin/products" className={baseClasses}>
       ...
       <Link href="/admin/orders" className={baseClasses}>
        {mobile && <span className="text-lg">📦</span>} Orders
      </Link>  
      <Link href="/admin/analytics" className={baseClasses}>
        {mobile && <span className="text-lg">📦</span>} Insights
      </Link>  
