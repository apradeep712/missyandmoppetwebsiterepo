 ...
 * Palette: Off-White, Pastel Pink (#FFE4E1), Pastel Blue (#E0F7FA), Deep Taupe Text (#4A4238)
 */
export default function AboutPage() {
  ...
  return (
    // CHANGED: Text color is now #4A4238 (Deep Taupe) instead of Black
    <main ref={containerRef} className="bg-[#FAFAF5] text-[#4A4238] min-h-screen selection:bg-[#FFD1DC] selection:text-[#4A4238] overflow-hidden">
      ...
      <section className="relative pt-32 pb-20 px-6 min-h-[80vh] flex flex-col justify-center items-center text-center">
        ...
        {/* Floating Abstract Shape (Pastel Pink) */}
        <motion.div 
        ...
        />
        {/* Floating Abstract Shape (Pastel Blue) */}
        <motion.div 
        ...
        >
          ...
          {/* Sticker - CHANGED to Pastel Blue theme */}
      ...
      <section className="py-20 px-4 md:px-8 max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6 auto-rows-[minmax(300px,auto)]">
          ...
          <div className="md:col-span-8 bg-white p-10 md:p-14 rounded-[2rem] shadow-sm flex flex-col justify-center border border-[#F0F0F0]">
            ...
            <p className="mt-6 text-lg text-[#9A8C7D] font-medium">— Anushree, Founder</p>
          </div>

          {/* CELL 2: VISUAL (Founder Photo) */}
          <div className="md:col-span-4 relative rounded-[2rem] overflow-hidden group">
            <img src="/about/founder.PNG" className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110" alt="Anushree and baby" />
            <div className="absolute inset-0 bg-[#4A4238]/10 group-hover:bg-transparent transition-colors" />
            <div className="absolute bottom-6 left-6 text-white font-bold uppercase tracking-widest text-xs">The Catalyst</div>
          </div>

          {/* CELL 3: THE FABRIC GAP (Changed to Pastel Pink BG) */}
          ...
          {/* CELL 4: CUSTOMIZATION (Changed from Black to Pastel Blue BG) */}
      ...
      {/* =========================================
          3. NEW SECTION: PHILOSOPHY & MOTHERHOOD
          (Pastel Cards, Emotional Connection)
      ========================================= */}
      <section className="py-24 px-6 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          {/* CARD 1: FABRIC QUALITY (Blue) */}
          <motion.div 
            whileHover={{ y: -10 }}
            className="bg-[#F0F8FF] p-8 rounded-t-[10rem] rounded-b-[2rem] text-center px-6 pt-20"
          >
            ...
            <p className="text-[#6D6359] leading-relaxed text-sm">
              We strictly use natural fibers. No synthetics that trap heat. Just pure, breathable cottons and linens that let their skin breathe while they conquer the playground.
            </p>
          </motion.div>

          {/* CARD 2: EMOTIONAL CONNECTION (Pink - Center Focus) */}
          <motion.div 
            whileHover={{ y: -10 }}
            className="bg-[#FFF0F5] p-8 rounded-[2rem] text-center flex flex-col justify-center order-first md:order-none border border-pink-100"
          >
            ...
            <p className="text-[#6D6359] leading-relaxed mb-6">
              We know that dressing your child is about more than just clothes. It's about capturing a moment in time before they outgrow it. We create pieces worthy of your photo albums.
            </p>
          ...
          {/* CARD 3: SENSORY DETAILS (Off White) */}
          <motion.div 
             whileHover={{ y: -10 }}
             className="bg-white border border-[#EBEBEB] p-8 rounded-t-[10rem] rounded-b-[2rem] text-center px-6 pt-20"
          >
            ...
            <p className="text-[#6D6359] leading-relaxed text-sm">
              No itchy tags. No pinching elastics. We finish our seams with care because we know that a comfortable child is a happy child (and a happy mom).
            </p>
          </motion.div>
      ...
      {/* =========================================
          4. FOOTER CTA (Pastel Blue Background)
      ========================================= */}
