...
export default function HomeHero() {  
  return (  
    <section className="relative overflow-hidden bg-gradient-to-br from-[#f9efe7] via-[#f5e5dd] to-[#e9d7cc]">  
      ...
      <div className="relative mx-auto flex min-h-[80vh] max-w-6xl flex-col items-center px-4 pb-16 pt-10 md:flex-row md:items-center md:justify-between md:pt-16">  
        {/* Left: About + Instagram */}  
        <div className="z-10 mb-10 max-w-xs md:mb-0 md:w-1/3">  
          ...
          <div className="mt-6 flex flex-wrap gap-3">  
            {/* Instagram button */}  
            <Link  
              href="https://instagram.com/yourbrandhandle"  
              target="_blank"  
        ...
        {/* Center: Glass "window" with main image + CTA */}  
        <div className="z-10 mb-10 w-full max-w-md md:mb-0 md:w-1/3">  
          <div className="relative mx-auto flex h-[420px] max-w-sm items-center justify-center rounded-[42px] border border-white/70 bg-white/20 shadow-[0_28px_80px_rgba(0,0,0,0.25)] backdrop-blur-2xl transition-transform duration-500 hover:-translate-y-1 hover:shadow-[0_38px_120px_rgba(0,0,0,0.35)]">  
            {/* Inner image / scene */}  
            <div className="relative h-[82%] w-[78%] overflow-hidden rounded-[32px] border border-white/60 bg-gradient-to-b from-[#f8f0ea] to-[#e8d8ce]">  
              {/* Replace this with your hero product image */}  
                         <HeroCarousel />  

            </div>
  
            {/* Brand mark in the center (floating text) */}  
            
  
            {/* Bottom pill with main CTA */}  
            <div className="absolute -bottom-7 flex w-full items-center justify-center">  
              <Link  
                href="/shop"  
                className="inline-flex items-center gap-2 rounded-full border border-white/80 bg-white/90 px-6 py-2 text-xs font-medium text-[#4b3b33] shadow-[0_18px_45px_rgba(0,0,0,0.20)] transition hover:bg-white"  
              >  
        ...
        <div className="z-10 max-w-xs text-right md:w-1/3">  
          <p className="text-[11px] font-medium uppercase tracking-[0.22em] text-[#b18b74]">  
            We are softness  
          </p>  
          <h1 className="mt-3 text-4xl font-semibold leading-[0.95] text-[#3b2c24] sm:text-5xl lg:text-6xl">  
            Missy & Mopet  
            <br />  
          
          </h1>  
          <p className="mt-4 text-[11px] text-[#8d6e5c]">  
